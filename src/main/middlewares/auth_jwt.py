...
from src.errors.types.http_unauthorized import HttpUnathorizedError
...
def auth_jwt_verify():
    ...
    if not raw_token or not user_id:
        raise HttpUnathorizedError("Invalid Auth informations")
    ...
    raise HttpUnathorizedError("User Unauthorized")
